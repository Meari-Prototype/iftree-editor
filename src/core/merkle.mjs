...
export function subtreeHashFrom(ownContentHash, childSubtreeHashes = []) {
...
export function computeSubtreeHashes(nodes = []) {
  ...
  const visit = (node) => {
    ...
    const entry = { contentHash: own, subtreeHash: subtreeHashFrom(own, childHashes) };
