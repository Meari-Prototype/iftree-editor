...
> **项目状态：0.6.3，早期开发阶段。** 项目仍在活跃开发中，请按早期版本对待：
>
> - **前端**：仍有较多已知 bug 未修复。
...
│   │   ├── source-text.ts / source-docx.ts / source-chm.ts # 配合 import-formats/ 解析 txt/md/csv/xlsx/docx/chm
